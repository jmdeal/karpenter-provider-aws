...
```shell
kubectl apply -f https://raw.githubusercontent.com/aws/karpenter/v1.0.0/pkg/apis/crds/karpenter.sh_nodepools.yaml
kubectl apply -f https://raw.githubusercontent.com/aws/karpenter/v1.0.0/pkg/apis/crds/karpenter.sh_nodeclaims.yaml
kubectl apply -f https://raw.githubusercontent.com/aws/karpenter/v1.0.0/pkg/apis/crds/karpenter.k8s.aws_ec2nodeclasses.yaml
```
